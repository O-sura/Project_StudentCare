        ...
        <div class="report-config-section">
            ...
            <div class="option-display-section">
                <form action=<?php echo URLROOT . "/admin/reports/" ?> method="post" id="report-input-form">
                    <div class="option-box"><input type="text" id="input-1" name="role" readonly></div>
                    <div class="option-box"><input type="text" id="input-2" name="type" readonly></div>
                    <div class="option-box"><input type="text" id="input-3" name="duration" readonly></div>
                </form>
            </div>
            ...
            <table class="reports">
                ...
                <?php foreach ($data as $report) : ?>
                    <tr>
                        ...
                        <td>
                            <button class="table-button <?php echo $report['filename']?>" id="report-download">Download</button>
                            <button class="table-button <?php echo $report['filename']?>" id="report-delete">Remove</button>
                        </td>
                    </tr>
                <?php endforeach ?>
