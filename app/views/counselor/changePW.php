...
<head>
    ...
    <link rel="stylesheet" href= <?php echo URLROOT . "/public/css/Counselor/changepw.css"?> >
...
<body>
    <div class="section">
        ...
        <div class="back-btn">
            ...
            <span class="btn-text"><a href=<?php echo URLROOT . "/Counsellor/editProfile"?>>Go Back to EditProfile</a></span>
        </div>
    </div>
</body>
</html>