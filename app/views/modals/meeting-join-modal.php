...
<head>
    ...
    <script src="modal-helper.js" defer></script>
</head>
<body>
    <section>
        ...
        <div class="modal-box-2">
                <button class="modal-box-button" id="join-meeting-button">Join Meeting</button>
                <button class="modal-box-button" id="cancel-appointment-button">Cancel Appointment</button>
                <button class="modal-box-button" id="close-button">Close</button>
        </div>
    </section>
</body>
</html>
