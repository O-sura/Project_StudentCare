...
fetch('http://localhost/StudentCare/Counsellor/getAppointmentStats')
    ...
    .then(data => {
      ...
      // const arrayApp = [
      //   {appointmentStatus : "0",role : "Pending"},
      //   {appointmentStatus : "1",role : "Completed"},
      //   {appointmentStatus : "2",role : "Requested"},
      //   {appointmentStatus : "3",role : "Cancelled"},
      // ];

      // console.log(arrayApp.role)

      data.forEach(obj => {
        if (obj.appointmentStatus == 0) {
          pending = (obj.count === undefined || obj.count === null) ? 0 : obj.count;
        } else if (obj.appointmentStatus == 1) {
          completed = (obj.count === undefined || obj.count === null) ? 0 : obj.count;
        } else if (obj.appointmentStatus == 2) {
          requested = (obj.count === undefined || obj.count === null) ? 0 : obj.count;
        } else if (obj.appointmentStatus == 3) {
          cancelled = (obj.count === undefined || obj.count === null) ? 0 : obj.count;
        }
      });
        ...
        new Chart("myChart", {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [sunCount,monCount,tueCount,wedCount,thurCount,friCount,satCount],
                    hoverOffset: 1
                }]
            },
