...
function dropdownFilter(option){
    ...
    xhr.open("GET", "http://localhost/StudentCare/Student_facility/uni_furniture_filter_handler/?filter=" + option , true);
...
function dropDownPrice(uni,sort){
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("GET", "http://localhost/StudentCare/Student_facility/price_furniture_sorter_handler/?sort=" + sort + '&uni=' + uni, true);
...
function dropDownRating(uni,sort){
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("GET", "http://localhost/StudentCare/Student_facility/rating_furniture_sorter_handler/?sort=" + sort + '&uni=' + uni, true);
...
function dropDownDate(uni,sort){
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("GET", "http://localhost/StudentCare/Student_facility/date_furniture_sorter_handler/?sort=" + sort + '&uni=' + uni, true);
...
function searchListing() {
        ...
        var xhr = new XMLHttpRequest();
        xhr.open("GET", "http://localhost/StudentCare/Student_facility/furniture_search_listing/?query=" + keyword + '&uni=' + uni5, true);
